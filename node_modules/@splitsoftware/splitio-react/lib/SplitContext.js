...
if (!react_1["default"] || !react_1["default"].createContext)
    throw new Error(constants_1.EXCEPTION_NO_REACT_OR_CREATECONTEXT);
/**
 ...
 */
var SplitContext = react_1["default"].createContext({
    client: null,
    factory: null,
    isReady: false,
