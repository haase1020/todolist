...
var useManager = function () {
    if (!utils_1.checkHooks(constants_1.ERROR_UM_NO_USECONTEXT))
        return null;
    var factory = react_1["default"].useContext(SplitContext_1["default"]).factory;
    return factory ? factory.manager() : null;
};
exports["default"] = useManager;
